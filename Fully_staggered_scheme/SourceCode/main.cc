...
namespace PhaseField_T_and_u_and_d
{
  ...
  void constrained_least_square(
      ...
      const std::list<Vector<double>> &delta_t_vector_list, Vector<double> &alpha)
  {
    ...
    const double scale = delta_u_vector_list.back() * delta_u_vector_list.back() +
                         ...
                         delta_t_vector_list.back() * delta_t_vector_list.back();
  ...
  namespace Parameters
  {
    ...
    void Scenario::declare_parameters(ParameterHandler &prm)
    {
      prm.enter_subsection("Scenario");
      {
        ...
        prm.declare_entry(
            "Nonlinear solver type", "Newton", Patterns::Selection("Newton"),
    ...
    void NonlinearSolver::declare_parameters(ParameterHandler &prm)
    {
      prm.enter_subsection("Nonlinear solver");
      {
        ...
        prm.declare_entry("Tolerance T residual", "1.0e-9", Patterns::Double(0.0),
        ...
        prm.declare_entry("Tolerance u increment", "1.0e-9", Patterns::Double(0.0),
                          "Mechanical increment tolerance");

        prm.declare_entry("Tolerance T increment", "1.0e-9", Patterns::Double(0.0),
  ...
  private:
    ...
    void assemble_system_one_cell_u(
        ...
        ScratchData_ASM_U &scratch, PerTaskData_ASM_U &data) const;
    void assemble_rhs_u();
    void assemble_rhs_one_cell_u(
        const typename DoFHandler<dim>::active_cell_iterator &cell,
        ScratchData_RHS_U &scratch, PerTaskData_RHS_U &data) const;
    ...
    void anderson_acceleration_step(
        ...
        double &temperature_inc_l2, double &temperature_residual_l2,
    ...
    void over_relaxation_step(
        ...
        double &phasefield_residual_l2, double &temperature_inc_l2,
        double &temperature_residual_l2, double &total_residual_l2_current,
  ...
  template <int dim>
  void SplitSolveTandUandD<dim>::anderson_acceleration_step(
      std::list<Vector<double>> &delta_u_vector_list,
      std::list<Vector<double>> &delta_d_vector_list,
      std::list<Vector<double>> &delta_t_vector_list,
      std::list<Vector<double>> &u_vector_list,
      ...
      Vector<double> &solution_displacement_anderson,
      Vector<double> &solution_phasefield_anderson,
      Vector<double> &solution_temperature_anderson, double &displacement_inc_l2,
      double &displacement_residual_l2, double &phasefield_inc_l2,
      double &phasefield_residual_l2, double &temperature_inc_l2,
      double &temperature_residual_l2, double &total_residual_l2_current,
      double &energy_functional_current,
      ...
      const Vector<double> &solution_temperature_prev_iter)
  {
    ...
    if (delta_u_vector_list.size() > 1)
    {
      ...
      constrained_least_square(delta_u_vector_list, delta_d_vector_list,
                               delta_t_vector_list, alpha_vector);
      ...
      for (unsigned int i = 0; i < alpha_size - 1; ++i)
      {
        ...
        solution_temperature_anderson +=
            alpha_vector(i) * (*std::next(itr_t_begin, i));
      }
      solution_displacement_anderson +=
          alpha_vector(alpha_size - 1) * m_solution_u;
      solution_phasefield_anderson += alpha_vector(alpha_size - 1) * m_solution_d;
      solution_temperature_anderson +=
          alpha_vector(alpha_size - 1) * m_solution_t;
  ...
  template <int dim>
  void SplitSolveTandUandD<dim>::over_relaxation_step(
      Vector<double> &solution_displacement_diff,
      Vector<double> &solution_phasefield_diff,
      Vector<double> &solution_temperature_diff,
      unsigned int &linear_solve_needed, double &displacement_inc_l2,
  ...
  template <int dim>
  void SplitSolveTandUandD<dim>::read_material_data(
  ...
  template <int dim>
  void SplitSolveTandUandD<dim>::read_time_data(
  ...
  template <int dim> void SplitSolveTandUandD<dim>::setup_qph()
  {
      ...
      const Vector<double> &solution_delta_u)
  {
    ...
    WorkStream::run(
        ...
        IteratorPair3(IteratorTuple3(m_dof_handler_u.end(), m_dof_handler_t.end(),
                                     m_dof_handler_d.end())),
  ...
  template <int dim> struct SplitSolveTandUandD<dim>::ScratchData_UQPH
  {
  ...
  void SplitSolveTandUandD<dim>::update_qph_incremental_one_cell(
      const IteratorPair3 &synchronous_iterators, ScratchData_UQPH &scratch,
      PerTaskData_UQPH & /*data*/)
  {
    scratch.reset();
  ...
  template <int dim> struct SplitSolveTandUandD<dim>::PerTaskData_ASM_U
  {
  ...
  template <int dim> struct SplitSolveTandUandD<dim>::PerTaskData_ASM_T
  {
    FullMatrix<double> m_cell_matrix;
    Vector<double> m_cell_rhs;
    std::vector<types::global_dof_index> m_local_dof_indices;
  ...
  template <int dim> struct SplitSolveTandUandD<dim>::PerTaskData_ASM_D
  {
    FullMatrix<double> m_cell_matrix;
    Vector<double> m_cell_rhs;
    std::vector<types::global_dof_index> m_local_dof_indices;
  ...
  template <int dim> struct SplitSolveTandUandD<dim>::PerTaskData_RHS_T
  {
    Vector<double> m_cell_rhs;
    std::vector<types::global_dof_index> m_local_dof_indices;
  ...
  template <int dim> struct SplitSolveTandUandD<dim>::PerTaskData_RHS_D
  {
    Vector<double> m_cell_rhs;
    std::vector<types::global_dof_index> m_local_dof_indices;
  ...
  template <int dim> struct SplitSolveTandUandD<dim>::PerTaskData_RHS_U
  {
    Vector<double> m_cell_rhs;
    std::vector<types::global_dof_index> m_local_dof_indices;
  ...
  template <int dim> struct SplitSolveTandUandD<dim>::ScratchData_ASM_U
  {
  ...
  template <int dim> struct SplitSolveTandUandD<dim>::ScratchData_ASM_T
  {
    FEValues<dim> m_fe_values_t;
    FEValues<dim> m_fe_values_u;
  ...
  template <int dim> struct SplitSolveTandUandD<dim>::ScratchData_ASM_D
  {
    FEValues<dim> m_fe_values;
  ...
  template <int dim> struct SplitSolveTandUandD<dim>::ScratchData_RHS_U
  {
    FEValues<dim> m_fe_values;
    FEFaceValues<dim> m_fe_face_values;
  ...
  template <int dim> struct SplitSolveTandUandD<dim>::ScratchData_RHS_D
  {
    FEValues<dim> m_fe_values;
  ...
  template <int dim> struct SplitSolveTandUandD<dim>::ScratchData_RHS_T
  {
    FEValues<dim> m_fe_values_t;
    FEValues<dim> m_fe_values_u;
    FEFaceValues<dim> m_fe_face_values_t;
  ...
  SplitSolveTandUandD<dim>::SplitSolveTandUandD(const std::string &input_file)
      : m_parameters(input_file),
        ...
        m_dof_handler_u(m_triangulation), m_dof_handler_t(m_triangulation),
  ...
  template <int dim> void SplitSolveTandUandD<dim>::make_grid()
  {
  ...
  template <int dim> void SplitSolveTandUandD<dim>::make_grid_case_1()
  {
  ...
  template <int dim> void SplitSolveTandUandD<dim>::make_grid_case_2()
  {
    for (unsigned int i = 0; i < 80; ++i)
      m_logfile << "*";
    m_logfile << std::endl;
  ...
  template <int dim> void SplitSolveTandUandD<dim>::make_grid_case_3()
  {
    for (unsigned int i = 0; i < 80; ++i)
      m_logfile << "*";
    m_logfile << std::endl;
  ...
  template <int dim> void SplitSolveTandUandD<dim>::make_grid_case_4()
  {
    for (unsigned int i = 0; i < 80; ++i)
      m_logfile << "*";
    m_logfile << std::endl;
  ...
  template <int dim> void SplitSolveTandUandD<dim>::make_grid_case_5()
  {
    for (unsigned int i = 0; i < 80; ++i)
      m_logfile << "*";
    m_logfile << std::endl;
  ...
  template <int dim> void SplitSolveTandUandD<dim>::make_grid_case_6()
  {
    for (unsigned int i = 0; i < 80; ++i)
      m_logfile << "*";
    m_logfile << std::endl;
  ...
  template <int dim> void SplitSolveTandUandD<dim>::setup_system()
  {
    ...
    m_logfile << "\t\tTriangulation:"
              ...
              << m_dof_handler_u.n_dofs() + m_dof_handler_t.n_dofs() +
  ...
  template <int dim> void SplitSolveTandUandD<dim>::setup_system_t()
  {
    ...
    DynamicSparsityPattern dsp(m_dof_handler_t.n_dofs(),
                               m_dof_handler_t.n_dofs());
    DoFTools::make_sparsity_pattern(m_dof_handler_t, dsp, m_constraints_t,
                                    /*keep_constrained_dofs = */ false);
  ...
  template <int dim> void SplitSolveTandUandD<dim>::setup_system_u()
  {
    ...
    DynamicSparsityPattern dsp(m_dof_handler_u.n_dofs(),
                               m_dof_handler_u.n_dofs());
    DoFTools::make_sparsity_pattern(m_dof_handler_u, dsp, m_constraints_u,
                                    /*keep_constrained_dofs = */ false);
    ...
    if (apply_dirichlet_bc)
    {
      ...
      if (m_parameters.m_scenario == 1 || m_parameters.m_scenario == 3)
      {
        ...
        VectorTools::interpolate_boundary_values(
            m_dof_handler_u, boundary_id_bottom_surface,
        ...
        */
        ...
        VectorTools::interpolate_boundary_values(
            m_dof_handler_u, boundary_id_top_surface,
            Functions::ConstantFunction<dim>(disp_magnitude * time_inc, dim),
            m_constraints_u, m_fe_u.component_mask(y_displacement));
      }
      else if (m_parameters.m_scenario == 2 || m_parameters.m_scenario == 4)
      {
        ...
        VectorTools::interpolate_boundary_values(
            m_dof_handler_u, boundary_id_top_surface,
            Functions::ConstantFunction<dim>(disp_magnitude * time_inc, dim),
            m_constraints_u, m_fe_u.component_mask(x_displacement));

        const int boundary_id_side_surfaces = 2;
        VectorTools::interpolate_boundary_values(
            m_dof_handler_u, boundary_id_side_surfaces,
            Functions::ZeroFunction<dim>(dim), m_constraints_u,
            m_fe_u.component_mask(y_displacement));
      }
      else if (m_parameters.m_scenario == 5)
      {
        ...
        VectorTools::interpolate_boundary_values(
            m_dof_handler_u, boundary_id_mid_surface_x,
            Functions::ZeroFunction<dim>(dim), m_constraints_u,
            m_fe_u.component_mask(x_displacement));

        const int boundary_id_mid_surface_y = 3;
        VectorTools::interpolate_boundary_values(
            m_dof_handler_u, boundary_id_mid_surface_y,
            Functions::ZeroFunction<dim>(dim), m_constraints_u,
            m_fe_u.component_mask(y_displacement));
      }
      else if (m_parameters.m_scenario == 6)
...
*/
  ...
  template <int dim> void SplitSolveTandUandD<dim>::assemble_system_d()
  {
  ...
  template <int dim> void SplitSolveTandUandD<dim>::assemble_system_u()
  {
    ...
    ScratchData_ASM_U scratch_data(m_fe_u, m_qf_cell, uf_cell, m_qf_face,
                                   uf_face);

    auto worker =
        [this](const typename DoFHandler<dim>::active_cell_iterator &cell,
               ScratchData_ASM_U &scratch, PerTaskData_ASM_U &data) {
          this->assemble_system_one_cell_u(cell, scratch, data);
        };

    auto copier = [this](const PerTaskData_ASM_U &data) {
      this->m_constraints_u.distribute_local_to_global(
          data.m_cell_matrix, data.m_cell_rhs, data.m_local_dof_indices,
          m_tangent_matrix_u, m_system_rhs_u);
    };
  ...
  template <int dim> void SplitSolveTandUandD<dim>::assemble_system_t()
  {
    ...
    ScratchData_ASM_T scratch_data(m_fe_t, m_fe_u, m_qf_cell, uf_cell, m_qf_face,
                                   uf_face, m_solution_previous_u,
                                   m_solution_previous_t);

    auto worker = [this](const IteratorPair2 &synchronous_iterators,
                         ScratchData_ASM_T &scratch, PerTaskData_ASM_T &data) {
      this->assemble_system_one_cell_t(synchronous_iterators, scratch, data);
    };

    auto copier = [this](const PerTaskData_ASM_T &data) {
      this->m_constraints_t.distribute_local_to_global(
          data.m_cell_matrix, data.m_cell_rhs, data.m_local_dof_indices,
          m_tangent_matrix_t, m_system_rhs_t);
    };

    WorkStream::run(IteratorPair2(IteratorTuple2(m_dof_handler_t.begin_active(),
  ...
  template <int dim> void SplitSolveTandUandD<dim>::assemble_rhs_u()
  {
    ...
    ScratchData_RHS_U scratch_data(m_fe_u, m_qf_cell, uf_cell, m_qf_face,
                                   uf_face);

    auto worker =
        [this](const typename DoFHandler<dim>::active_cell_iterator &cell,
               ScratchData_RHS_U &scratch, PerTaskData_RHS_U &data) {
          this->assemble_rhs_one_cell_u(cell, scratch, data);
        };

    auto copier = [this](const PerTaskData_RHS_U &data) {
      this->m_constraints_u.distribute_local_to_global(
          data.m_cell_rhs, data.m_local_dof_indices, m_system_rhs_u);
    };
  ...
  template <int dim> void SplitSolveTandUandD<dim>::assemble_rhs_d()
  {
  ...
  void SplitSolveTandUandD<dim>::assemble_system_one_cell_t(
      const IteratorPair2 &synchronous_iterators, ScratchData_ASM_T &scratch,
      PerTaskData_ASM_T &data) const
  {
    data.reset();
    scratch.reset();
    std::get<0>(*synchronous_iterators)
        ->get_dof_indices(data.m_local_dof_indices);
    ...
    scratch.m_fe_values_t.get_function_values(
        scratch.m_solution_t_previous_step,
    ...
    heat_supply(scratch.m_fe_values_t.get_quadrature_points(), heat_supply_values,
                m_parameters.m_heat_supply * 1.0);

    for (const unsigned int q_point :
         scratch.m_fe_values_t.quadrature_point_indices())
    {
         ...
         scratch.m_fe_values_t.quadrature_point_indices())
    {
      ...
      {
        data.m_cell_rhs(i) +=
            heat_capacity * N_temperature[i] * old_temperature / ref_t * JxW;
        ...
        for (const unsigned int j :
             scratch.m_fe_values_t.dof_indices_ending_at(i))
          data.m_cell_matrix(i, j) +=
    ...
    for (const auto &face : std::get<0>(*synchronous_iterators)->face_iterators())
      ...
      {
        scratch.m_fe_face_values_t.reinit(std::get<0>(*synchronous_iterators),
                                          face);

        for (const unsigned int f_q_point :
             scratch.m_fe_face_values_t.quadrature_point_indices())
        {
    ...
    for (const unsigned int i : scratch.m_fe_values_t.dof_indices())
      for (const unsigned int j :
           scratch.m_fe_values_t.dof_indices_starting_at(i + 1))
        data.m_cell_matrix(i, j) = data.m_cell_matrix(j, i);
  }
            ...
            (gc * length_scale * grad_N[i] * phasefield_grad +
             (gc / length_scale * phasefield_value +
              ...
              degradation_function_derivative(phasefield_value, p, a1, a2, a3,
                  m_parameters.m_phasefield_name) * history_value) *
                 N[i]) *
            JxW;
      } // i
    }   // q_point
  ...
  template <int dim> void SplitSolveTandUandD<dim>::assemble_rhs_t()
  {
    ...
    ScratchData_RHS_T scratch_data(m_fe_t, m_fe_u, m_qf_cell, uf_cell, m_qf_face,
                                   uf_face, m_solution_previous_u,
                                   m_solution_previous_t);

    auto worker = [this](const IteratorPair2 &synchronous_iterators,
                         ScratchData_RHS_T &scratch, PerTaskData_RHS_T &data) {
      this->assemble_rhs_one_cell_t(synchronous_iterators, scratch, data);
    };

    auto copier = [this](const PerTaskData_RHS_T &data) {
      this->m_constraints_t.distribute_local_to_global(
          data.m_cell_rhs, data.m_local_dof_indices, m_system_rhs_t);
    };
  ...
  void SplitSolveTandUandD<dim>::assemble_rhs_one_cell_t(
      const IteratorPair2 &synchronous_iterators, ScratchData_RHS_T &scratch,
      PerTaskData_RHS_T &data) const
  {
    data.reset();
    scratch.reset();
  ...
  template <int dim> void SplitSolveTandUandD<dim>::update_history_field_step()
  {
    for (const auto &cell : m_triangulation.active_cell_iterators())
    {
  ...
  template <int dim>
  unsigned int
  SplitSolveTandUandD<dim>::displacement_step(unsigned int itr_stagger)
  {
  ...
  template <int dim> void SplitSolveTandUandD<dim>::temperature_step()
  {
    make_constraints_t();
    assemble_system_t();
  ...
  template <int dim> void SplitSolveTandUandD<dim>::make_constraints_t()
  {
    m_constraints_t.clear();
    DoFTools::make_hanging_node_constraints(m_dof_handler_t, m_constraints_t);
    ...
    if (m_parameters.m_scenario == 1 || m_parameters.m_scenario == 3)
    {
      ...
      double bottom_temperature =
          m_parameters.m_ref_temperature; // temperature BC
      ...
      VectorTools::interpolate_boundary_values(
          m_dof_handler_t, boundary_id_bottom_surface,
          Functions::ConstantFunction<dim>(bottom_temperature), m_constraints_t);
      ...
      VectorTools::interpolate_boundary_values(
          ...
          Functions::ConstantFunction<dim>(top_temperature), m_constraints_t);
    }
    else if (m_parameters.m_scenario == 2 || m_parameters.m_scenario == 4)
    {
      // Since the thermal problem is linear, we directly set the temperature at
    ...
    else if (m_parameters.m_scenario == 5)
    {
      ...
      VectorTools::interpolate_boundary_values(
          m_dof_handler_t, boundary_id_left_surface,
      ...
      Vector<double> &newton_update_u)
  {
    ...
    if (m_parameters.m_type_linear_solver == "Direct")
    {
      ...
      A_direct.vmult(newton_update_u, m_system_rhs_u);
    }
    else if (m_parameters.m_type_linear_solver == "CG")
    {
      ...
      cg_u.solve(m_tangent_matrix_u, newton_update_u, m_system_rhs_u,
                 preconditioner_u);
    }
    else
    {
  ...
  template <int dim> void SplitSolveTandUandD<dim>::solve_linear_system_t()
  {
    ...
    if (m_parameters.m_type_linear_solver == "Direct")
    {
      ...
      A_direct.vmult(m_solution_t, m_system_rhs_t);
    }
    else if (m_parameters.m_type_linear_solver == "CG")
    {
      ...
      cg_t.solve(m_tangent_matrix_t, m_solution_t, m_system_rhs_t,
                 preconditioner_t);
    }
    else
    {
      AssertThrow(false, ExcMessage("Selected linear solver not implemented for "
                                    "the temperature subproblem!"));
    }
  ...
  template <int dim>
  unsigned int SplitSolveTandUandD<dim>::solve_nonlinear_newton_u(
      Vector<double> &solution_delta_u, unsigned int iter_stagger)
  {
  ...
  template <int dim> void SplitSolveTandUandD<dim>::output_results() const
  {
    ...
    data_out.add_data_vector(m_dof_handler_u, m_solution_u, solution_name_u,
                             data_component_interpretation_u);

    data_out.add_data_vector(m_dof_handler_d, m_solution_d, "phasefield");

    data_out.add_data_vector(m_dof_handler_t, m_solution_t, "temperature");
  ...
  void SplitSolveTandUandD<dim>::calculate_reaction_force(unsigned int face_ID)
  {
    ...
    std::vector<std::vector<Tensor<1, dim>>> Nx(
        m_qf_cell.size(), std::vector<Tensor<1, dim>>(m_fe_u.n_dofs_per_cell()));
    std::vector<std::vector<Tensor<2, dim>>> grad_Nx(
        m_qf_cell.size(), std::vector<Tensor<2, dim>>(m_fe_u.n_dofs_per_cell()));
    std::vector<std::vector<SymmetricTensor<2, dim>>> symm_grad_Nx(
        m_qf_cell.size(),
        std::vector<SymmetricTensor<2, dim>>(m_fe_u.n_dofs_per_cell()));
    ...
    DoFTools::map_dof_to_boundary_indices(m_dof_handler_u, boundary_ids, mapping);
  ...
  template <int dim>
  std::pair<double, double> SplitSolveTandUandD<
  ...
  template <int dim> void SplitSolveTandUandD<dim>::print_parameter_information()
  {
    ...
    while (cell_refine_flag)
    {
      ...
      if (cell_refine_flag)
      {
        ...
        solution_transfer_u.prepare_for_coarsening_and_refinement(
            m_solution_previous_u);
        SolutionTransfer<dim, Vector<double>> solution_transfer_t(
            m_dof_handler_t);
        solution_transfer_t.prepare_for_coarsening_and_refinement(
            m_solution_previous_t);
        ...
        solution_transfer_u.interpolate(m_solution_previous_u,
        ...
        // If an older version of dealII is used, for example, 9.4.0,
        // interpolate() needs to use the following interface.
        solution_transfer_t.interpolate(m_solution_previous_t,
                                        tmp_solution_previous_t);
#endif
  ...
  template <int dim> void SplitSolveTandUandD<dim>::run()
  {
    ...
    while (m_time.current() < m_time.end() - m_time.get_delta_t() * 1.0e-6)
    {
           ...
           ++adp_refine_iteration)
      {
             ...
             ++iter_stagger)
        {
          ...
          total_residual_l2_current = std::sqrt(u_residual_l2 * u_residual_l2 +
              ...
              (d_inc_l2 < m_parameters.m_tol_d_incr))
          {
            ...
            m_logfile << "\t\tAbsolute increment of temperature (T): " << t_inc_l2
                      << std::endl;
              ...
              if (total_residual_l2_current <= total_residual_l2_previous)
              {
                ...
                if (m_parameters.m_anderson_depth > 0)
                {
                  ...
                  anderson_acceleration_step(
                      delta_u_vector_list, delta_d_vector_list,
                      delta_t_vector_list, u_vector_list, d_vector_list,
                      t_vector_list, solution_u_diff, solution_d_diff,
                      solution_t_diff, solution_u_anderson, solution_d_anderson,
                      solution_t_anderson, u_inc_l2, u_residual_l2, d_inc_l2,
                      d_residual_l2, t_inc_l2, t_residual_l2,
                      total_residual_l2_current, energy_functional_current,
                      solution_u_prev_iter, solution_d_prev_iter,
              ...
              else
              {
                    ...
                    1.0e-6)
                {
                  over_relaxation_step(
                      solution_u_diff, solution_d_diff, solution_t_diff,
                      linear_solve_needed, u_inc_l2, u_residual_l2, d_inc_l2,
                      d_residual_l2, t_inc_l2, t_residual_l2,
                      total_residual_l2_current, energy_functional_current,
                      solution_u_prev_iter, solution_d_prev_iter,
                      solution_t_prev_iter, iter_stagger);
                }
...
int main(int argc, char *argv[])
{
  ...
  if (dim == 2)
  {
    PhaseField_T_and_u_and_d::SplitSolveTandUandD<2> Phasefield2D(
        "parameters.prm");
    Phasefield2D.run();
  }
  else if (dim == 3)
  {
    PhaseField_T_and_u_and_d::SplitSolveTandUandD<3> Phasefield3D(
        "parameters.prm");
    Phasefield3D.run();
  }
  else
